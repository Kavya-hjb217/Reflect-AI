export const MOODS = {
  ...
  ENERGETIC: {
    ...
    score: 9,
    color: "yellow",
    prompt: "What's giving you a boost of energy?",
    pixabayQuery: "energy+power+dynamic",
  },
  APPRECIATED: {
    id: "appreciated",
    label: "Appreciated",
  ...
  OPTIMISTIC: {
    ...
    score: 8,
    color: "amber",
    prompt: "What are you feeling positive about for the future?",
    pixabayQuery: "optimistic+sunrise+hopeful",
  },
  RELAXED: {
    id: "relaxed",
    label: "Relaxed",
    ...
    score: 8,
    color: "teal",
    prompt: "What helped you unwind and relax?",
    pixabayQuery: "relaxed+calm+yoga+beach",
  },
  PEACEFUL: {
    id: "peaceful",
    label: "Peaceful",
  ...
  CONTENT: {
    ...
    score: 7,
    color: "stone",
    prompt: "What's making you feel content and satisfied right now?",
    pixabayQuery: "content+satisfied+cozy",
  },
  THOUGHTFUL: {
    id: "thoughtful",
    label: "Thoughtful",
  ...
  CONFUSED: {
    ...
    score: 4,
    color: "purple",
    prompt: "What feels unclear or puzzling right now?",
    pixabayQuery: "confused+question+mark+maze",
  },
  BORED: {
    id: "bored",
    label: "Bored",
    ...
    score: 3,
    color: "zinc",
    prompt: "What could you do to make things more interesting?",
    pixabayQuery: "boredom+waiting+empty+room",
  },
  OVERWHELMED: {
    id: "overwhelmed",
    label: "Overwhelmed",
  ...
  HURT: {
    ...
    score: 2,
    color: "blue",
    prompt: "What caused this feeling of hurt?",
    pixabayQuery: "hurt+broken+heart+pain",
  },
  ANGRY: {
    id: "angry",
    label: "Angry",
